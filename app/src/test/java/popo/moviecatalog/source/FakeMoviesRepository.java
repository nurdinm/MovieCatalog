...
import popo.moviecatalog.data.source.MoviesDataSource;
import popo.moviecatalog.data.source.MoviesRepository;
import popo.moviecatalog.data.source.NetworkBoundResource;
...
public class FakeMoviesRepository implements MoviesDataSource {

    private volatile static FakeMoviesRepository INSTANCE = null;

    private final LocalRepository localRepository;
    private final RemoteRepository remoteRepository;
    private final AppExecutors appExecutors;

    FakeMoviesRepository(LocalRepository localRepository, RemoteRepository remoteRepository, AppExecutors appExecutors) {
        this.localRepository = localRepository;
        this.remoteRepository = remoteRepository;
        this.appExecutors = appExecutors;
    }

    public static FakeMoviesRepository getInstance(LocalRepository localRepository, RemoteRepository remoteData, AppExecutors appExecutors) {
        if (INSTANCE == null) {
            synchronized (MoviesRepository.class) {
                if (INSTANCE == null) {
                    INSTANCE = new FakeMoviesRepository(localRepository,remoteData,appExecutors);
                }
            }
        }
        return INSTANCE;
